                ...
                <div class="container-fluid">
                    <div class="form-head d-flex flex-wrap mb-sm-4 mb-3 align-items-center">
                        <div class="mr-auto  d-lg-block mb-3">
                            <h2 class="text-black mb-0 font-w500">Blog</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="forming">
                                                <div class="sign">
                                                    <form class="sign-div" method="POST" action="{{ route('admin.post.blog', Crypt::encrypt(Auth::user()->id)) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <label>Title:</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 mb-4">
                                                                        <input type="file" placeholder="Enter Image" name="image" class="input">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                            ...
                                                            <div class="col-md-12 mb-3">
                                                                <button value="submit" required> Upload Blog</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
