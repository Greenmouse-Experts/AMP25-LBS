                        ...
                        <div class="col-xl-5 col-md-6 col-12 border-t border-right">
                            <div class="page-account-form">
                                ...
                                <div class="">
                                    <div class="forming">
                                        <div class="sign">
                                            <form class="sign-div" method="POST" action="{{ route('profile.update', Crypt::encrypt(Auth::user()->id)) }}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 mb-4">
                                                                <input type="tel" placeholder="Enter Your Phone Number" value="{{Auth::user()->phone_number}}" name="phone_number" class="input" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 mb-4">
                                                                <textarea type="text" placeholder="Enter Your Address" value="{{Auth::user()->address}}" name="address" class="input" required>{{Auth::user()->address}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 mb-4">
                                                                <input type="text" placeholder="Enter Your Occupation" value="{{Auth::user()->occupation}}" name="occupation" class="input">
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-xl-4 col-md-6 border-t col-12">
                            <div class="page-account-form">
                                ...
                                <div class="">
                                    <div class="forming">
                                        <div class="sign">
                                            <form class="sign-div" method="POST" action="{{ route('update.password', Crypt::encrypt(Auth::user()->id)) }}">
                                                @csrf
                                                <div class="row">
                                                    <!--Old Password-->
                                                    <div class="col-md-12">
