            ...
            <div class="row">
                ...
                <div class="col-md-4 form-area">
                    <div class="col-lg-12 text-center header-form">
                        ...
                        <p>Remenber Password? <a href="/login">Login</a></p>
                    </div>
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="row">
                            ...
                            <!--Forgot password-->
                            <div class="col-lg-12 py-2 text-center forgotten">
                                <p>We'll sent a mail to your registered email to reset your passowrd.</p>
                            </div>
                        </div>
                    </form>
                </div>
